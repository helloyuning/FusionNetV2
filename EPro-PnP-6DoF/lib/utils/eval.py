...
class Evaluation(object):
    ...
    def evaluate_pose(self):
        ...
        for i, cls_name in enumerate(self.classes):
            ...
            # print("pose est, pose gt:",len(curr_poses_est), len(curr_poses_gt))
            # print("pose est类型:", len(curr_poses_est),len(curr_poses_est[0])) #[1050, 3]
            # print("pose gt类型:", len(curr_poses_gt),len(curr_poses_gt[0])) #[1050,4]
            for j in range(num):
